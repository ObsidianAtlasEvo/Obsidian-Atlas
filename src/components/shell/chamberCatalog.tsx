...
export const ICONS: Record<string, string> = {
  ...
  realityLedger: 'M4 4h16v16H4zM4 9h16M4 14h16M9 4v16',
...
export const CHAMBERS: ReadonlyArray<ChamberDef> = [
  ...
  { id: 'reality-ledger',  label: 'Reality Ledger', icon: 'realityLedger',description: 'Honest implementation state of every surface', section: 'control' },
