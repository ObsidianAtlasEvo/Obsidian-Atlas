      ...
      <div style={{ maxWidth: 980, margin: '0 auto', display: 'flex', flexDirection: 'column', gap: 24 }}>
        ...
        >
          <div style={{ color: T.goldSoft, fontSize: '0.64rem', letterSpacing: '0.12em' }}>
            SYSTEM REALITY — SOURCE AUDIT OF MAIN
          </div>
          <div style={{ color: T.muted, fontSize: '0.8rem', lineHeight: 1.6 }}>
            ...
            doctrine awaiting construction. States here are a conservative <em>source</em> audit — derived
            from routing and registered endpoints, not from live probes — so nothing is marked runtime-verified
            without a cited run. Per-surface evidence and gaps below are the authoritative record; the ledger
            lists itself, with its own limits.
          </div>
        </section>
