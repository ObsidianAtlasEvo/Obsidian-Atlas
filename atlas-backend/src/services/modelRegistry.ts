...
export type Tier = 'free' | 'paid' | 'deprecated';
...
const OPENAI_MODELS: ModelDefinition[] = [
  {
    ...
    provider: 'openai',
    name: 'GPT-5.4 Nano',
    description: "OpenAI's fastest and most affordable GPT-5.4 model. Ideal for routing, classification, and high-throughput tasks.",
    tier: 'free',
    contextWindow: 400_000,
    strengths: ['speed', 'classification', 'routing', 'cost-efficiency', 'structured-output'],
  ...
  },
  {
    ...
    provider: 'openai',
    name: 'GPT-5.4 Mini',
    description: "Balanced GPT-5.4 variant. Strong reasoning and coding at moderate cost. Good for specialist and synthesis tasks.",
    tier: 'paid',
    contextWindow: 400_000,
  ...
  },
  {
    ...
    provider: 'openai',
    name: 'GPT-5.4',
    description: "OpenAI's flagship model. 1M+ context window, powerful reasoning, coding, and analysis. Supports structured output.",
    tier: 'paid',
    contextWindow: 1_050_000,
    strengths: ['reasoning', 'coding', 'analysis', 'long-context', 'structured-output'],
  ...
  },
  {
    ...
    provider: 'openai',
    name: 'GPT-5.4 Pro',
    description: "OpenAI's most powerful model for hard arbitration tasks. Gated — requires sovereign tier. No structured output.",
    tier: 'paid',
    contextWindow: 1_050_000,
  ...
  // Legacy — kept for compatibility fallback only
  {
    id: 'openai/gpt-4o',
    provider: 'openai',
    name: 'GPT-4o (Deprecated)',
    description: "DEPRECATED — compatibility fallback only. Use GPT-5.4 family instead.",
    tier: 'deprecated',
    contextWindow: 128_000,
    strengths: ['reasoning', 'vision', 'general-purpose'],
...
const ANTHROPIC_MODELS: ModelDefinition[] = [
  {
    ...
    description: "Fast elite coding, nuanced writing, strong reasoning. Sovereign tier only.",
    tier: 'paid',
    contextWindow: 200_000,
    strengths: ['coding', 'nuanced-writing', 'reasoning', 'analysis', 'long-context'],
  ...
  },
  {
    ...
    description: "Frontier reasoning, elite coding, nuanced writing. Sovereign tier only.",
    tier: 'paid',
    contextWindow: 200_000,
    strengths: ['frontier-reasoning', 'elite-coding', 'creative-writing', 'research', 'complex-analysis'],
...
const GOOGLE_MODELS: ModelDefinition[] = [
  {
    ...
    description: "Google's most capable Gemini model. Industry-leading 1M+ context, strong at multimodal and long-doc tasks.",
    tier: 'free',
  ...
  },
  {
    ...
    description: "Free-tier Overseer model. Public preview — lightweight, fast, 1M context. Used as default Overseer for free tier.",
    tier: 'free',
    contextWindow: 1_000_000,
...
const GROQ_MODELS: ModelDefinition[] = [
  {
    ...
    description: 'Llama 3.3 70B running on Groq\'s LPU hardware. Extremely fast inference — primary free-tier routing model.',
    tier: 'free',
    contextWindow: 128_000,
    strengths: ['speed', 'reasoning', 'instruction-following', 'routing', 'free-tier'],
    isLocal: false,
    defaultEnabled: true,
    requiresApiKey: true,
  },
